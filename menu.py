...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item_number = input("Please choose the item you want to order: ")
...
for order in orders:
    ...
    spaces_quantity = " " * num_spaces_quantity

    # 10. Print the item name, price, and quantity
    print(f"{item_name}{spaces_item}| ${price}{spaces_price}| {quantity}{spaces_quantity}")
